...
@section('page') <li class="breadcrumb-item active">Entry Nilai Sikap</li>
@endsection
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($data->sikap($data->id) && $data->sikap($data->id)['id'])
                                            ...
                                            <input
                                                type="hidden"
                                                name="sikap_id"
                                                class="sikap_id_{{ $data->id }}"
                                                value="{{ $data->sikap($data->id)['id'] }}"
                                            >
                                    ...
                                    @if ($data->sikap($data->id) && $data->sikap($data->id)['sikap_1'])
                                        ...
                                        <td class="ctr">
                                            ...
                                            <div class="text-center">
                                                {{ $data->sikap($data->id)['sikap_1'] }}
                                            </div>

                                            <input
                                                type="hidden"
                                                name="sikap_1"
                                                class="sikap_1_{{ $data->id }}"
                                                value="{{ $data->sikap($data->id)['sikap_1'] }}"
                                            >
                                    ...
                                    @else
                                        ...
                                        <td class="ctr">
                                            ...
                                            <input
                                                ...
                                                name="sikap_1"
                                                maxlength="1"
                                                onkeypress="return sikap(event)"
                                                style="margin: auto;"
                                                class="form-control text-center sikap_1_{{ $data->id }}"
                                                autocomplete="off"
                                                autofocus
                                            >
                                    ...
                                    @if ($data->sikap($data->id) && $data->sikap($data->id)['sikap_2'])
                                        ...
                                        <td class="ctr">
                                            ...
                                            <div class="text-center">
                                                {{ $data->sikap($data->id)['sikap_2'] }}
                                            </div>

                                            <input
                                                type="hidden"
                                                name="sikap_2"
                                                class="sikap_2_{{ $data->id }}"
                                                value="{{ $data->sikap($data->id)['sikap_2'] }}"
                                            >
                                    ...
                                    @else
                                        ...
                                        <td class="ctr">
                                            ...
                                            <input
                                                ...
                                                onkeypress="return sikap(event)"
                                                style="margin: auto;"
                                                class="form-control text-center sikap_2_{{ $data->id }}"
                                                autocomplete="off"
                                                autofocus
                                            >
                                    ...
                                    @if ($data->sikap($data->id) && $data->sikap($data->id)['sikap_3'])
                                        ...
                                        <td class="ctr">
                                            ...
                                            <input
                                                type="hidden"
                                                name="sikap_3"
                                                class="sikap_3_{{ $data->id }}"
                                                value="{{ $data->sikap($data->id)['sikap_3'] }}"
                                            >
                                    ...
                                    @else
                                        ...
                                        <td class="ctr">
                                            ...
                                            <input
                                                ...
                                                onkeypress="return sikap(event)"
                                                style="margin: auto;"
                                                class="form-control text-center sikap_3_{{ $data->id }}"
                                                autocomplete="off"
                                                autofocus
                                            >
    ...
    $(".btn_click").click(function(){
        ...
        $.ajax({
            ...
            error: function(data){
                ...
                toastr.warning("Terjadi kesalahan saat menyimpan nilai sikap.");
