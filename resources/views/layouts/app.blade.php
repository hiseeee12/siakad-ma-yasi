...
<body class="hold-transition login-page login-right" style="background-image: url('{{ asset("img/wallup.jpg") }}'); background-size: cover; background-attachment: fixed;">
  ...
  <div class="login-box">
    ...
    <footer style="color: white;">
      <marquee>
          <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="" style="color: white;">MA YASI</a>. </strong>
      </marquee>
    </footer>
  </div>
...
@error('id_card')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Guru MA YASI!");
  </script>
@enderror
@error('guru')
  <script>
...
@error('no_induk')
  <script>
    toastr.error("Maaf User ini tidak terdaftar sebagai Siswa MA YASI!");
  </script>
@enderror
@error('siswa')
  <script>
