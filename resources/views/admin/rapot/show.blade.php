    ...
    <div id="rapor">
        ...
        <table class="header-table">
            <tr>
                <td class="logo" width="12%">
                    <img src="{{ asset('img/favicon.png') }}" onerror="this.style.display='none'">
                </td>
                <td align="center">
                    <div class="sub-instansi">KEMENTERIAN AGAMA REPUBLIK INDONESIA</div>
                    <div class="nama-instansi">MADRASAH ALIYAH YAYASAN SOSIAL ISLAM</div>
                    <div class="alamat">Jalan Mandalika Permas</div>
                    <div class="alamat">Kecamatan Brati, Kabupaten Grobogan - Jawa Tengah</div>
                </td>
            </tr>
        </table>
        ...
        <table class="identitas">
            <tr>
                ...
                <td class="titik">:</td>
                <td class="isi"><b>{{ $siswa->nama_siswa }}</b></td>
                <td class="kanan">Kelas</td>
                <td class="titik">:</td>
                <td class="isi-kanan"><b>{{ $kelas->nama_kelas }}</b></td>
            </tr>
            <tr>
                <td>NIS/NISN</td>
                <td>:</td>
            ...
            <tr>
                <td>Alamat</td>
                <td>:</td>
                <td colspan="4">Jalan Mandalika Permas</td>
            </tr>
        </table>
            ...
            <tbody>
                @foreach ($mapel as $val => $item)
                    ...
                    <tr>
                        ...
                        <td class="text-center">{{ $nilai['p_nilai'] ?? '-' }}</td>
                        <td class="keterangan">{{ $nilai['p_deskripsi'] ?? '-' }}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
        ...
        <div style="width:48%; margin-top:18px; border:1px solid #000;">
            <table style="width:100%; border-collapse:collapse;">
                <tr style="background:#efefef;">
                    <td colspan="3" style="padding:7px; text-align:center; font-weight:bold; border-bottom:1px solid #000;">
        ...
        <table class="nilai-table" style="width:40%;">
            ...
            <tr>
                <td>Alpa</td>
                <td>{{ $absensi->alpa ?? 0 }} Hari</td>
            </tr>
        </table>

        @php
            // $tahunPelajaran sudah dipanggil di bagian paling atas
            // sehingga kita hanya perlu query CatatanWali saja
            $catatan = \App\CatatanWali::where('siswa_id', $siswa->id)
                ->where('tahun_pelajaran_id', $tahunPelajaran->id ?? 0)
                ->first();
        @endphp
        ...
        <table class="nilai-table">
            <tr>
                <td>
                    <b>
                        Berdasarkan hasil belajar yang dicapai pada semester ini, peserta didik dinyatakan :
                        <br><br>
        ...
        <table class="footer-table" style="margin-top:35px; width:100%;">
            ...
            <tr>
                <td></td>
                <td align="center">Kepala Madrasah</td>
            </tr>
            <tr>
