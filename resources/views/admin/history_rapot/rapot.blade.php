...
@section('heading', 'History Rapor Siswa')

@section('page') <li class="breadcrumb-item"> <a href="{{ route('history-rapot.index') }}">History Rapor</a> </li>


<li class="breadcrumb-item">
    <a href="{{ route('history-rapot.show', $siswa->id) }}">
        {{ $siswa->nama_siswa }}
    </a>
</li>

<li class="breadcrumb-item active">
    Rapor {{ $tahunPelajaran->tahun_pelajaran ?? '-' }}
</li>
