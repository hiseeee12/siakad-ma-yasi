...
Route::middleware(['auth'])->group(function () {
 ...
 Route::middleware(['guru'])->group(function () {
    ...
    Route::get('/guru/ekstrakurikuler',
'EkstrakurikulerController@index')
->name('ekstrakurikuler.index');


Route::get('/guru/ekstrakurikuler/{id}',
'EkstrakurikulerController@show')
->name('ekstrakurikuler.show');


Route::post('/guru/ekstrakurikuler/store',
'EkstrakurikulerController@store')
->name('ekstrakurikuler.store');


Route::delete('/guru/ekstrakurikuler/{id}',
'EkstrakurikulerController@destroy')
->name('ekstrakurikuler.destroy');
Route::get('/guru/prestasi',
'PrestasiController@index')
->name('prestasi.index');


Route::get('/guru/prestasi/{id}',
'PrestasiController@show')
->name('prestasi.show');


Route::post('/guru/prestasi/store',
'PrestasiController@store')
->name('prestasi.store');


Route::delete('/guru/prestasi/{id}',
'PrestasiController@destroy')
->name('prestasi.destroy');
Route::get('/guru/kenaikan-kelas',
'KenaikanKelasController@index')
->name('kenaikan.index');


Route::post('/guru/kenaikan-kelas/store',
'KenaikanKelasController@store')
->name('kenaikan.store');

    Route::resource('/guru-absensi', 'GuruAbsensiController')
    ->names('guru.absensi');
Route::get('/guru/kokurikuler',
    'KokurikulerController@index'
)->name('kokurikuler.index');


Route::post('/guru/kokurikuler/store',
    'KokurikulerController@store'
)->name('kokurikuler.store');
    // CATATAN WALI KELAS
    Route::get('/catatan-wali', 'CatatanWaliController@index')
        ->name('catatan.index');

    Route::post('/catatan-wali', 'CatatanWaliController@store')
        ->name('catatan.store');
  ...
  Route::middleware(['admin'])->group(function () {
    ...
    Route::put('/tahun-pelajaran/{id}/aktifkan', 'TahunPelajaranController@aktifkan')->name('tahun-pelajaran.aktifkan');
    Route::resource('/tahun-pelajaran', 'TahunPelajaranController');
    Route::get('tahun-pelajaran-trash', 'TahunPelajaranController@trash')->name('tahun-pelajaran.trash');
    Route::get('tahun-pelajaran-trash/{id}/restore', 'TahunPelajaranController@restore')->name('tahun-pelajaran.restore');
    Route::delete('tahun-pelajaran-trash/{id}/kill', 'TahunPelajaranController@kill')->name('tahun-pelajaran.kill');
    Route::get('/history-rapot', 'HistoryRapotController@index')->name('history-rapot.index');
    Route::get('/history-rapot/{id}', 'HistoryRapotController@show')->name('history-rapot.show');
    Route::get('/history-rapot/{id}/rapot/{tahunPelajaranId}', 'HistoryRapotController@rapot')->name('history-rapot.rapot');
